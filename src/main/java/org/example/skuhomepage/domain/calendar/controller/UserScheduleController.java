...
public class UserScheduleController implements UserScheduleControllerSpec {
  ...
  public ApiResponse<List<UserScheduleDTO>> getUserCalendar(int year, int month, int day) {
    ...
    return ApiResponse.onSuccess(userScheduleService.getUserSchedule(year, month, day));
  }
  ...
  public ApiResponse<Void> addUserSchedule(AddUserScheduleDTO requestDTO) {
    ...
    return ApiResponse.onCreated(
        URI.create("/api/calendars/users/" + userScheduleService.addUserSchedule(requestDTO)));
  }
  ...
  public ApiResponse<UserScheduleDTO> updateUserSchedule(
    ...
    return ApiResponse.onSuccess(userScheduleService.updateUserSchedule(scheduleId, requestDTO));
  }
