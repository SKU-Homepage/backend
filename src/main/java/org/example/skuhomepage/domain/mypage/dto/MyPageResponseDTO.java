...
public class MyPageResponseDTO {
    public record MyPageInfoDTO(
        ...
        @Schema(description = "재학상태", example ="재학")
        String status
    ...
    public record LoginResultDTO(
        ...
        @Schema(description ="account", example ="qws1566@skuniv.ac.kr")
        String account,

        @Schema(description ="accessToken",example="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJxd3MxNTY2QHNrdW5pdi5hYy5rciIsImV4cCI6MTY0NzQwNjYwNn0.7")
        String accessToken,
