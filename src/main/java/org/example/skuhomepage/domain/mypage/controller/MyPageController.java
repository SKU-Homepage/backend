...
public class MyPageController implements MyPageControllerSpec {
    ...
    public ApiResponse<LoginResultDTO> googleLogin(String code) {
        ...
        return ApiResponse.onSuccess(new LoginResultDTO(1L,"qws1566@skuniv.ac.kr","eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJxd3MxNTY2QHNrdW5pdi5hYy5rciIsImV4cCI6MTY0NzQwNjYwNn0.7","",
