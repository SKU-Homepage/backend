...
public interface AlarmRepository extends JpaRepository<Alarm, Long> {
  ...
  @Query("SELECT n FROM Alarm n WHERE n.user.account = :account AND n.id = :alarmId")
  Optional<Alarm> findByIdAndUser_Account(
      @Param("alarmId") Long alarmId, @Param("account") String account);
}
